...
module DigitalLock_addr_router_001_default_decode
  #(
...
module DigitalLock_addr_router_001
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD8 = log2ceil(64'h5078 - 64'h5070); 
    localparam PAD9 = log2ceil(64'h5080 - 64'h5078); 
    // -------------------------------------------------------
    ...
    DigitalLock_addr_router_001_default_decode the_default_decode(
    ...
    // ( 0x5078 .. 0x5080 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 15'h5078   ) begin
