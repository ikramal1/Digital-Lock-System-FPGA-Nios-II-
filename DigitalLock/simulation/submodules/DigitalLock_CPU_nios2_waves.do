add wave -noupdate -divider {DigitalLock_CPU: top-level ports}
...
add wave -noupdate -divider {DigitalLock_CPU: common}
...
add wave -noupdate -divider {DigitalLock_CPU: breaks}
