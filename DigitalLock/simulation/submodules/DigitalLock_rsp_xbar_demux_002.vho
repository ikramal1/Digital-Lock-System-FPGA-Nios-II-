...
--synthesis_resources = 
 ...
 ENTITY  DigitalLock_rsp_xbar_demux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END DigitalLock_rsp_xbar_demux_002;

 ARCHITECTURE RTL OF DigitalLock_rsp_xbar_demux_002 IS
 ...
 END RTL; --DigitalLock_rsp_xbar_demux_002
