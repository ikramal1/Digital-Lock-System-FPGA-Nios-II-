...
--synthesis_resources = 
 ...
 ENTITY  DigitalLock_cmd_xbar_demux_001 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 ...
		 src5_data	:	OUT  STD_LOGIC_VECTOR (89 DOWNTO 0);
		 ...
		 src6_data	:	OUT  STD_LOGIC_VECTOR (89 DOWNTO 0);
		 ...
		 src7_data	:	OUT  STD_LOGIC_VECTOR (89 DOWNTO 0);
		 ...
		 src8_data	:	OUT  STD_LOGIC_VECTOR (89 DOWNTO 0);
		 ...
		 src9_data	:	OUT  STD_LOGIC_VECTOR (89 DOWNTO 0);
		 src9_endofpacket	:	OUT  STD_LOGIC;
		 src9_ready	:	IN  STD_LOGIC;
		 src9_startofpacket	:	OUT  STD_LOGIC;
		 src9_valid	:	OUT  STD_LOGIC
	 ); 
 END DigitalLock_cmd_xbar_demux_001;

 ARCHITECTURE RTL OF DigitalLock_cmd_xbar_demux_001 IS
	 ...
	 SIGNAL  s_wire_digitallock_cmd_xbar_demux_001_wideor0_21_dataout :	STD_LOGIC;
 ...
 END RTL; --DigitalLock_cmd_xbar_demux_001
