...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "DigitalLock"
} 
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/DigitalLock_IN_RAM.hex ./
  file copy -force $QSYS_SIMDIR/submodules/DigitalLock_CPU_ociram_default_contents.dat ./
  file copy -force $QSYS_SIMDIR/submodules/DigitalLock_CPU_ociram_default_contents.hex ./
  file copy -force $QSYS_SIMDIR/submodules/DigitalLock_CPU_ociram_default_contents.mif ./
  file copy -force $QSYS_SIMDIR/submodules/DigitalLock_CPU_rf_ram_a.dat ./
  file copy -force $QSYS_SIMDIR/submodules/DigitalLock_CPU_rf_ram_a.hex ./
  file copy -force $QSYS_SIMDIR/submodules/DigitalLock_CPU_rf_ram_a.mif ./
  file copy -force $QSYS_SIMDIR/submodules/DigitalLock_CPU_rf_ram_b.dat ./
  file copy -force $QSYS_SIMDIR/submodules/DigitalLock_CPU_rf_ram_b.hex ./
  file copy -force $QSYS_SIMDIR/submodules/DigitalLock_CPU_rf_ram_b.mif ./
}
...
ensure_lib                                                                          ./libraries/IN_RAM/                                                                  
vmap       IN_RAM                                                                   ./libraries/IN_RAM/                                                                  
...
alias com {
  echo "\[exec\] com"
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_irq_mapper.vho"                                                               -work irq_mapper                                                              
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_rsp_xbar_mux_001.vho"                                                         -work rsp_xbar_mux_001                                                        
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_rsp_xbar_mux.vho"                                                             -work rsp_xbar_mux                                                            
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_rsp_xbar_demux_002.vho"                                                       -work rsp_xbar_demux_002                                                      
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_cmd_xbar_mux.vho"                                                             -work cmd_xbar_mux                                                            
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_cmd_xbar_demux_001.vho"                                                       -work cmd_xbar_demux_001                                                      
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_cmd_xbar_demux.vho"                                                           -work cmd_xbar_demux                                                          
  ...
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_id_router_002.vho"                                                            -work id_router_002                                                           
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_id_router.vho"                                                                -work id_router                                                               
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_addr_router_001.vho"                                                          -work addr_router_001                                                         
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_addr_router.vho"                                                              -work addr_router                                                             
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo
  ...
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_sysid.vho"                                                                    -work sysid                                                                   
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_TIMER.vhd"                                                                    -work TIMER                                                                   
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_SW.vhd"                                                                       -work SW                                                                      
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_KEY.vhd"                                                                      -work KEY                                                                     
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_LEDR.vhd"                                                                     -work LEDR                                                                    
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_LEDG.vhd"                                                                     -work LEDG                                                                    
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_HEX.vhd"                                                                      -work HEX                                                                     
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_JTAG_UART.vhd"                                                                -work JTAG_UART                                                               
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_IN_RAM.vhd"                                                                   -work IN_RAM                                                                  
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_CPU.vhd"                                                                      -work CPU                                                                     
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_CPU_jtag_debug_module_sysclk.vhd"                                             -work CPU                                                                     
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_CPU_jtag_debug_module_tck.vhd"                                                -work CPU                                                                     
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_CPU_jtag_debug_module_wrapper.vhd"                                            -work CPU                                                                     
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_CPU_oci_test_bench.vhd"                                                       -work CPU                                                                     
  vcom     "$QSYS_SIMDIR/submodules/DigitalLock_CPU_test_bench.vhd"                                                           -work CPU                                                                     
  vcom     "$QSYS_SIMDIR/DigitalLock.vhd"                                                                                                                                                                   
  vcom     "$QSYS_SIMDIR/digitallock_cpu_instruction_master_translator.vhd"                                                                                                                                 
  vcom     "$QSYS_SIMDIR/digitallock_cpu_data_master_translator.vhd"                                                                                                                                        
  vcom     "$QSYS_SIMDIR/digitallock_cpu_jtag_debug_module_translator.vhd"                                                                                                                                  
  vcom     "$QSYS_SIMDIR/digitallock_in_ram_s1_translator.vhd"                                                                                                                                              
  vcom     "$QSYS_SIMDIR/digitallock_jtag_uart_avalon_jtag_slave_translator.vhd"                                                                                                                            
  vcom     "$QSYS_SIMDIR/digitallock_hex_s1_translator.vhd"                                                                                                                                                 
  vcom     "$QSYS_SIMDIR/digitallock_key_s1_translator.vhd"                                                                                                                                                 
  vcom     "$QSYS_SIMDIR/digitallock_timer_s1_translator.vhd"                                                                                                                                               
  vcom     "$QSYS_SIMDIR/digitallock_sysid_control_slave_translator.vhd"                                                                                                                                    
  vcom     "$QSYS_SIMDIR/digitallock_rst_controller.vhd"                                                                                                                                                    
  vcom     "$QSYS_SIMDIR/digitallock_rst_controller_001.vhd"                                                                                                                                                
}
